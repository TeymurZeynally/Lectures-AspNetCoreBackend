...
```powershell
dotnet ef migrations add InitialScaffold --startup-project ..\Lecture08.CatsApi\Lecture08.CatsApi.csproj
```
...
```powershell
dotnet ef migrations add AddUserAddress --startup-project ..\Lecture08.CatsApi\Lecture08.CatsApi.csproj
```
...
```powershell
dotnet ef database update --startup-project ..\Lecture08.CatsApi\Lecture08.CatsApi.csproj
```
