...
```powershell
dotnet ef migrations add InitialScaffold --startup-project ..\Lecture09.ErrorHandling.CatsApi\Lecture09.ErrorHandling.CatsApi.csproj
```
...
```powershell
dotnet ef migrations add AddUserAddress --startup-project ..\Lecture09.ErrorHandling.CatsApi\Lecture09.ErrorHandling.CatsApi.csproj
```
...
```powershell
dotnet ef database update --startup-project ..\Lecture09.ErrorHandling.CatsApi\Lecture09.ErrorHandling.CatsApi.csproj
```
