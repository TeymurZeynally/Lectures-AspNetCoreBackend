...
```powershell
dotnet ef migrations add InitialScaffold --startup-project ..\Lecture09.CatsApi\Lecture09.CatsApi.csproj
```
...
```powershell
dotnet ef migrations add AddUserAddress --startup-project ..\Lecture09.CatsApi\Lecture09.CatsApi.csproj
```
...
```powershell
dotnet ef database update --startup-project ..\Lecture09.CatsApi\Lecture09.CatsApi.csproj
```
